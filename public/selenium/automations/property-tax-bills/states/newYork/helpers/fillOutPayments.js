...
const deleteInputFieldContents = require("../../../../../utils/web-elements/deleteInputFieldContents");
...
const fillOutPayments = async (
  ...
  if (installmentNumber === "1") {
    ...
    */
    ...
    await sendKeysInputFields(totalLiability, newTotalLiabilityString, false);
